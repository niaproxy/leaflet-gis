...
L.Control.mouseCoordinate  = L.Control.extend({
    ...
    _update: function(e){
        ...
        if(this.options.gsk){
            var dLat = (Math.round(lat * 100000) / 100000)+0.000003130191445;
            var dLng = (Math.round(lng * 100000) / 100000)+0.000003130191445;
            if(dLat !== undefined){
                content += "<tr><td>ГСК-2011</td><td colspan='2'>" + dLat + "</td><td> " + dLng +"</td></tr>";
            }
        }
